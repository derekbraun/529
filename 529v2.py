...
'''
    ...
    performances over many thousands of simulations. This is called bootstrap
    Monte Carlo sampling. This approach captures stochasticity (randomness)
    much better than parametric summary statistics such as variance or 
    standard deviation.
